...
class SpeedModifierPickerState extends State<SpeedModifierPicker> {
  ...
  Future<void> changePlaybackSpeedSubmit() async {
    double d = (double.tryParse(_numberInputController.text) ?? 1).clamp(minSpeed / 100, maxSpeed / 100);
      ...
      content: Column(mainAxisSize: MainAxisSize.min, children: [
        TextFormField(
            ...
            decoration: InputDecoration(
                labelText: S.current.playbackSpeed, hintText: S.current.playbackSpeed, icon: const Icon(Icons.speed))),
        Slider(
          value: progress,
          min: minSpeed,
          max: maxSpeed,
