...
class CurrentlyPlayingBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    bool dontShow = context.select((PlayerStateExtended value) =>
        !value.paused && !value.playing || value.processingState == ProcessingState.completed);
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Expanded(
                          child: Column(
                            children: <Widget>[
                              Consumer<PlayerSong>(builder: (context, playerSong, child) {
                                return SizedBox(
                                  height: 20,
                                  child: TextScroll(
                                    playerSong.song != null
                                        ? currentlyPlayingTextFromMetadata(playerSong.song!)
                                        : "NULL",
                              ...
                              Consumer<PlayerPosition>(builder: (context, playerPosition, child) {
                                ...
                                return Column(
                                  children: [
                                    ...
                                    Text(formatTimeDisplay(
                                        playerPosition.position, playerPosition.duration ?? Duration.zero)),
                                  ],
                                );
                              }),
                            ],
